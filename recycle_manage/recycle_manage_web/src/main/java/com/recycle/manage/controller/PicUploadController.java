...
import com.recycle.common.PicUploadResult;
...
public class PicUploadController {
	...
	public String upload(@RequestParam("uploadFile") MultipartFile uploadFile , HttpServletResponse response) throws Exception {
		...
		// 生成图片的绝对引用地址
		String picUrl = StringUtils.replace(StringUtils.substringAfter(filePath, "D:\\recycle\\recycle_upload"), "\\", "/");
		fileUploadResult.setUrl("http://image.recycle.com" + picUrl);
	...
	private String getFilePath(String sourceFileName) {
		String baseFolder = "D:\\recycle\\recycle_upload" + File.separator + "images";
